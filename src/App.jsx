...
function App() {
  ...
  useEffect(() => {
    if (urunler.length <= 1 || isPaused) return
  ...
  return (
    <>
      ...
      <main
        id="main-content"
        className="min-h-screen flex flex-col items-center justify-start pt-[14vh] md:pt-[18vh] bg-white text-gray-900 px-6 pb-20 font-sans"
      >
        ...
        {urunler.length === 0 ? (
          <p className="text-gray-500">Henüz ürün fotoğrafı eklenmemiş.</p>
        ) : (
          <>
            <div
              className="relative w-full max-w-xl md:max-w-2xl aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl bg-gray-100 mb-10"
              role="region"
                ...
                <>
                  ...
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2">
                    ...
                    <button
                      ...
                      aria-label={isPaused ? 'Slaytı oynat' : 'Slaytı durdur'}
                      className="ml-2 p-1.5 rounded-full bg-white/80 hover:bg-white text-gray-800 shadow-md transition"
                    >
            ...
            <section className="w-full max-w-5xl" aria-labelledby="hizmetler-baslik">
              <h2
                id="hizmetler-baslik"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                {hizmetler.map((hizmet, index) => (
                  ...
                  >
                    <div className="mb-4 text-gray-800" aria-hidden="true">
                      {hizmet.icon}
                    </div>
